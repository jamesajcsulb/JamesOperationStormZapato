...
class LoginQuick: AppCompatActivity() {
    ...
    fun createGoogleSignInOption() {
        ...
        googleApiClient = GoogleApiClient.Builder(this@LoginQuick)
                .enableAutoManage(this@LoginQuick  /* OnConnectionFailedListener */) { }
    ...
    fun FirebaseUserAuth(googleSignInAccount: GoogleSignInAccount?) {
        ...
        this.firebaseAuth.signInWithCredential(authCredential).addOnCompleteListener { task: Task<AuthResult> ->
            if (task.isSuccessful) {
                ...
                //Registration error
                Toast.makeText(this@LoginQuick, "Something Went Wrong", Toast.LENGTH_LONG).show()
            }
        }
    }
