...
public class OrdersRecyclerDetailsViewAdapter extends RecyclerView.Adapter<OrdersRecyclerDetailsViewAdapter.ViewHolder> {
    ...
    public OrdersRecyclerDetailsViewAdapter(Context context, ArrayList<Shoe> shoeshoe, Context con, Activity a, Fragment fragm) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        myBrandTextView.setText("prof" + arrayList.get(position).getBrand());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Fragment fragment = new OrdersFragmentDetails();
