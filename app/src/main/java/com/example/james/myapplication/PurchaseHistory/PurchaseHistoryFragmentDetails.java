...
public class PurchaseHistoryFragmentDetails extends Fragment
{
    ...
    private PurchaseHistoryRecyclerDetailsViewAdapter adaptershoe;

    public static PurchaseHistoryFragmentDetails newInstance(String param1, String param2) {
        PurchaseHistoryFragmentDetails fragment = new PurchaseHistoryFragmentDetails();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public static PurchaseHistoryFragmentDetails newInstance()
    {
        return new PurchaseHistoryFragmentDetails();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adaptershoe = new PurchaseHistoryRecyclerDetailsViewAdapter(getContext(), classshoe, getContext(), getActivity(), new HomeFragment() );
