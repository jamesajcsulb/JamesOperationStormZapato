...
public class OrdersFragmentDetails extends Fragment
{
    ...
    private OrdersRecyclerDetailsViewAdapter adaptershoe;

    public static OrdersFragmentDetails newInstance(String param1, String param2) {
        OrdersFragmentDetails fragment = new OrdersFragmentDetails();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public static OrdersFragmentDetails newInstance()
    {
        return new OrdersFragmentDetails();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adaptershoe = new OrdersRecyclerDetailsViewAdapter(getContext(), classshoe, getContext(), getActivity(), new HomeFragment() );
